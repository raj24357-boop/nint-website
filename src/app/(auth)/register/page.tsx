...
import { Eye, EyeOff, UserPlus, Store, Loader2 } from "lucide-react";
        ...
        <div className="w-full max-w-md space-y-8 py-12">
          ...
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-slate-500">
              Join as a customer or a verified service professional.
            </p>
          </div>
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  ...
                  className={`flex items-center justify-center gap-2 rounded-2xl border-2 px-4 py-4 text-sm font-semibold transition-all ${
                    form.role === "CUSTOMER"
      ...
      <div className="hidden lg:flex lg:w-1/2">
        <div className="relative flex h-full w-full items-center justify-center overflow-hidden bg-indigo-900">
          ...
          <div className="relative z-10 max-w-md px-8 text-center">
            ...
            <h3 className="text-3xl font-bold text-white">India&apos;s trusted service marketplace</h3>
